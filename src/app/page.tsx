...
export default function HomePage() {
  console.log('[LOG] Attempting to render HomePage on the server...');
  try {
    return (
    ...
    console.error('[ERROR] Failed to render HomePage on the server:', error.message, error.stack);
    // This return won't be visible on a 404, but it's good practice.
    // The console.error is the important part.
    return (
      <div>
        <h1>Error</h1>
        <p>There was an error loading the homepage. Check the server logs for details.</p>
      </div>
    );
  }
}
